...
export default function PrivacyPolicyPage() {
  const sections = [
    ...
    { title: 'Contact Us', content: 'For any privacy-related queries or requests, please contact our Data Protection Officer at privacy@marengoasiahospitals.com or call +91-124-4141414. You can also write to: Data Protection Officer, Marengo Asia Hospitals, Sector 38, Gurugram, Haryana 122001.' },
  ];
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '15px', color: 'var(--gray-600)', lineHeight: 1.8, marginBottom: '32px' }}>
            Marengo Asia Hospitals (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy.
