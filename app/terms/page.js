...
export default function TermsPage() {
  const sections = [
    { title: 'Acceptance of Terms', content: 'By accessing and using the Marengo Asia Hospitals website and services, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our services. We reserve the right to modify these terms at any time, and your continued use constitutes acceptance of any changes.' },
    { title: 'Our Services', content: 'Marengo Asia Hospitals provides multi-super-speciality healthcare services including but not limited to outpatient consultations, inpatient care, surgical procedures, diagnostic services, preventive health checkups, telemedicine consultations, and emergency care. All medical services are provided by qualified and licensed medical professionals.' },
    ...
    { title: 'Limitation of Liability', content: 'While we strive to provide the highest quality healthcare, Marengo Asia Hospitals shall not be liable for outcomes beyond our reasonable control, delays caused by external factors, third-party service failures, or information provided by patients that is incomplete or inaccurate. Our liability is limited to the fees paid for the specific service in question.' },
    { title: 'Intellectual Property', content: 'All content on this website, including text, images, logos, and design, is the property of Marengo Asia Hospitals and protected by intellectual property laws. You may not reproduce, distribute, or use any content without our written permission.' },
