  ...
  const pages = [
    {
      slug: 'home',
      title: 'Home Page',
      metaTitle: "Marengo Asia Hospitals - India's Most Trusted Hospital Network",
      metaDescription: "Marengo Asia Hospitals is India's leading multi-super-speciality hospital network with 1600+ beds, 800+ doctors, and 45+ specialities across 6 locations. World-class healthcare.",
    ...
    },
    {
      slug: 'about',
      title: 'About Us',
      metaTitle: 'About Marengo Asia Hospitals - Transforming Lives Since 2000',
      metaDescription: "Founded by Dr. Naresh Trehan in 2000, Marengo Asia Hospitals has grown into India's most trusted hospital network. Learn about our story, leaders, awards and milestones.",
      ...
      content: JSON.stringify({
        ...
        introParagraph: "Founded in 2000 by Dr. Naresh Trehan, one of the world's most accomplished cardiovascular surgeons, Marengo Asia Hospitals was born from a singular vision: to create a healthcare institution in India that matches and exceeds the best hospitals in the world."
      })
    },
    {
      slug: 'contact',
      title: 'Contact Us',
      metaTitle: 'Contact Marengo Asia Hospitals - Helpdesk, Numbers & Addresses',
      metaDescription: 'Get in touch with Marengo Asia Hospitals branches in Gurugram, Noida, Lucknow, Patna, Indore, Ranchi. Book an appointment or call our emergency line.',
      metaKeywords: 'contact, hospital address, customer support, phone number',
      content: JSON.stringify({
        email: 'info@marengoasiahospitals.com',
    ...
    },
    {
      slug: 'careers',
      title: 'Careers',
      metaTitle: 'Careers at Marengo Asia Hospitals - Join Our Expert Medical Team',
    ...
    },
    {
      ...
      metaTitle: 'International Patient Services - Marengo Asia Hospitals India',
